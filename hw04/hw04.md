...
1. "horse" is missing from the animal\_LE table 2. the pets table says "bunny" and the animal\_LE says "rabbit"
...
EXTRA EXTRA! READ ALL ABOUT IT! Now that we're on the topic, it's worth mentioning how you would actually change the name of rabbit to bunny in your animal\_LE df.
